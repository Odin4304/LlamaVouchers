package net.lldv.llamavouchers.components.forms.custom;
...
import net.lldv.llamavouchers.components.forms.FormHandler;
...
public class CustomForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(LlamaVouchers.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
